...
// Returns whether a value is constant after constant folding. Internal use only.
RValue<Bool> isConstant(Value *);
...
public:
	...
	RValue<Bool> IsConstant() { return isConstant(value()); }
...
{
public:
	explicit Byte8(RValue<UShort8> cast);
...
{
public:
	explicit Short8(RValue<Int8> cast);
...
{
public:
	explicit UShort8(RValue<Int8> cast);
	...
	RValue<UShort8> operator=(RValue<Short8> rhs);
...
class Int8 : public LValue<Int8>
{
public:
	explicit Int8(RValue<Byte8> cast);
	explicit Int8(RValue<SByte8> cast);
	explicit Int8(RValue<Float8> cast);
	explicit Int8(RValue<Short8> cast);
	explicit Int8(RValue<UShort8> cast);

	Int8();
	Int8(int c);
	Int8(int c0, int c1, int c2, int c3, int c4, int c5, int c6, int c7);

	Int8(const Int &rhs);
	Int8(const Int8 &rhs);
	Int8(const UInt8 &rhs);
	Int8(RValue<Int>);
	Int8(RValue<Int8>);
	Int8(RValue<UInt8>);
	Int8(const Reference<Int> &rhs);
	Int8(const Reference<Int8> &rhs);
	Int8(const Reference<UInt8> &rhs);

	Int8(RValue<Int4> lo, RValue<Int4> hi);

	//RValue<Int8> operator=(RValue<Int> rhs);
	RValue<Int8> operator=(RValue<Int8> rhs);
	RValue<Int8> operator=(const Int8 &rhs);
	//RValue<Int8> operator=(const Reference<Int> &rhs);
	RValue<Int8> operator=(const Reference<Int8> &rhs);

	static Type *type();

private:
	void constant(int x, int y, int z, int w, int a, int b, int c, int d);
};
...
RValue<Int8> operator<<(RValue<Int8> lhs, RValue<Int8> rhs);
RValue<Int8> operator>>(RValue<Int8> lhs, RValue<Int8> rhs);
//RValue<Int8> operator+=(Int8 &lhs, RValue<Int8> rhs);
//	RValue<Int8> operator-=(Int8 &lhs, RValue<Int8> rhs);
//	RValue<Int8> operator*=(Int8 &lhs, RValue<Int8> rhs);
//	RValue<Int8> operator/=(Int8 &lhs, RValue<Int8> rhs);
//	RValue<Int8> operator%=(Int8 &lhs, RValue<Int8> rhs);
...
RValue<Int8> operator-(RValue<Int8> val);
RValue<Int8> operator~(RValue<Int8> val);
//	RValue<Int8> operator++(Int8 &val, int);   // Post-increment
//	const Int8 &operator++(Int8 &val);   // Pre-increment
//	RValue<Int8> operator--(Int8 &val, int);   // Post-decrement
//	const Int8 &operator--(Int8 &val);   // Pre-decrement
//	RValue<Bool> operator<(RValue<Int8> lhs, RValue<Int8> rhs);
//	RValue<Bool> operator<=(RValue<Int8> lhs, RValue<Int8> rhs);
//	RValue<Bool> operator>(RValue<Int8> lhs, RValue<Int8> rhs);
//	RValue<Bool> operator>=(RValue<Int8> lhs, RValue<Int8> rhs);
//	RValue<Bool> operator!=(RValue<Int8> lhs, RValue<Int8> rhs);
...
inline RValue<Int8> CmpGT(RValue<Int8> x, RValue<Int8> y)
{
	return CmpNLE(x, y);
}
inline RValue<Int8> CmpGE(RValue<Int8> x, RValue<Int8> y)
{
	return CmpNLT(x, y);
}

RValue<Int> Extract(RValue<Int8> val, int i);
RValue<Int8> Insert(RValue<Int8> val, RValue<Int> element, int i);
...
{
public:
	explicit UInt8(RValue<Float8> cast);

	UInt8();
	UInt8(int x);
	UInt8(unsigned int x, unsigned int y, unsigned int z, unsigned w, unsigned int a, unsigned int b, unsigned int c, unsigned int d);
	UInt8(RValue<UInt8> rhs);
	UInt8(const UInt8 &rhs);
	UInt8(const Reference<UInt8> &rhs);
	UInt8(RValue<Int8> rhs);
	UInt8(const Int8 &rhs);
	UInt8(const Reference<Int8> &rhs);
	UInt8(RValue<UInt4> lo, RValue<UInt4> hi);
	UInt8(RValue<UInt> rhs);
	UInt8(const UInt &rhs);
	UInt8(const Reference<UInt> &rhs);

	RValue<UInt8> operator=(RValue<UInt8> rhs);
	RValue<UInt8> operator=(const UInt8 &rhs);
	RValue<UInt8> operator=(const Reference<UInt8> &rhs);

	static Type *type();

private:
	void constant(unsigned int x, unsigned int y, unsigned int z, unsigned w, unsigned int a, unsigned int b, unsigned int c, unsigned int d);
};
...
RValue<UInt8> operator<<(RValue<UInt8> lhs, RValue<UInt8> rhs);
RValue<UInt8> operator>>(RValue<UInt8> lhs, RValue<UInt8> rhs);
//RValue<UInt8> operator+=(UInt8 &lhs, RValue<UInt8> rhs);
//RValue<UInt8> operator-=(UInt8 &lhs, RValue<UInt8> rhs);
//RValue<UInt8> operator*=(UInt8 &lhs, RValue<UInt8> rhs);
//	RValue<UInt8> operator/=(UInt8 &lhs, RValue<UInt8> rhs);
//	RValue<UInt8> operator%=(UInt8 &lhs, RValue<UInt8> rhs);
...
//RValue<UInt8> operator|=(UInt8 &lhs, RValue<UInt8> rhs);
//RValue<UInt8> operator^=(UInt8 &lhs, RValue<UInt8> rhs);
//RValue<UInt8> operator<<=(UInt8 &lhs, unsigned char rhs);
//RValue<UInt8> operator>>=(UInt8 &lhs, unsigned char rhs);
//RValue<UInt8> operator+(RValue<UInt8> val);
//RValue<UInt8> operator-(RValue<UInt8> val);
//RValue<UInt8> operator~(RValue<UInt8> val);
//	RValue<UInt8> operator++(UInt8 &val, int);   // Post-increment
//	const UInt8 &operator++(UInt8 &val);   // Pre-increment
//	RValue<UInt8> operator--(UInt8 &val, int);   // Post-decrement
//	const UInt8 &operator--(UInt8 &val);   // Pre-decrement
//	RValue<Bool> operator<(RValue<UInt8> lhs, RValue<UInt8> rhs);
//	RValue<Bool> operator<=(RValue<UInt8> lhs, RValue<UInt8> rhs);
//	RValue<Bool> operator>(RValue<UInt8> lhs, RValue<UInt8> rhs);
//	RValue<Bool> operator>=(RValue<UInt8> lhs, RValue<UInt8> rhs);
//	RValue<Bool> operator!=(RValue<UInt8> lhs, RValue<UInt8> rhs);
...
//RValue<UInt8> CmpEQ(RValue<UInt8> x, RValue<UInt8> y);
//RValue<UInt8> CmpLT(RValue<UInt8> x, RValue<UInt8> y);
//RValue<UInt8> CmpLE(RValue<UInt8> x, RValue<UInt8> y);
//RValue<UInt8> CmpNEQ(RValue<UInt8> x, RValue<UInt8> y);
//RValue<UInt8> CmpNLT(RValue<UInt8> x, RValue<UInt8> y);
//RValue<UInt8> CmpNLE(RValue<UInt8> x, RValue<UInt8> y);
//inline RValue<UInt8> CmpGT(RValue<UInt8> x, RValue<UInt8> y)
//{
//	return CmpNLE(x, y);
//}
//inline RValue<UInt8> CmpGE(RValue<UInt8> x, RValue<UInt8> y)
//{
//	return CmpNLT(x, y);
//}
//RValue<UInt8> Max(RValue<UInt8> x, RValue<UInt8> y);
//RValue<UInt8> Min(RValue<UInt8> x, RValue<UInt8> y);
//RValue<UInt8> MulHigh(RValue<UInt8> x, RValue<UInt8> y);
RValue<UInt> Extract(RValue<UInt8> val, int i);
RValue<UInt8> Insert(RValue<UInt8> val, RValue<UInt> element, int i);
//	RValue<UInt8> RoundInt(RValue<Float4> cast);
//RValue<UInt8> Swizzle(RValue<UInt8> x, uint16_t select);
//RValue<UInt8> Shuffle(RValue<UInt8> x, RValue<UInt8> y, uint16_t select);
...
template<typename T> RValue<T> FMA(RValue<T> a, RValue<T> b, RValue<T> c);
static inline RValue<Float> FMA(RValue<Float> a, RValue<Float> b, RValue<Float> c) { return FMA<Float>(a, b, c); }
// Deprecated: use Rcp
...
public:
	...
	Float4(Argument<Float4> argument);
...
static inline RValue<Float4> FMA(RValue<Float4> a, RValue<Float4> b, RValue<Float4> c) { return FMA<Float4>(a, b, c); }
...
{
public:
	explicit Float8(RValue<Byte8> cast);
	explicit Float8(RValue<SByte8> cast);
	explicit Float8(RValue<Short8> cast);
	explicit Float8(RValue<UShort8> cast);
	explicit Float8(RValue<Int8> cast);
	explicit Float8(RValue<UInt8> cast);

	Float8();
	Float8(float x);
	Float8(float x, float y, float z, float w, float a, float b, float c, float d);
	Float8(RValue<Float8> rhs);
	Float8(const Float8 &rhs);
	Float8(const Reference<Float8> &rhs);
	Float8(RValue<Float> rhs);
	Float8(const Float &rhs);
	Float8(const Reference<Float> &rhs);
	Float8(Argument<Float8> argument);

	//template<int T>
	//Float8(const SwizzleMask1<Float8, T> &rhs);
	//template<int T>
	//Float8(const Swizzle4<Float8, T> &rhs);
	//template<int X, int Y>
	//Float8(const Swizzle2<Float8, X> &x, const Swizzle2<Float8, Y> &y);
	//template<int X, int Y>
	//Float8(const SwizzleMask2<Float8, X> &x, const Swizzle2<Float8, Y> &y);
	//template<int X, int Y>
	//Float8(const Swizzle2<Float8, X> &x, const SwizzleMask2<Float8, Y> &y);
	//template<int X, int Y>
	//Float8(const SwizzleMask2<Float8, X> &x, const SwizzleMask2<Float8, Y> &y);
	Float8(RValue<Float4> lo, RValue<Float4> hi);

	RValue<Float8> operator=(float replicate);
	RValue<Float8> operator=(RValue<Float8> rhs);
	RValue<Float8> operator=(const Float8 &rhs);
	RValue<Float8> operator=(const Reference<Float8> &rhs);
	RValue<Float8> operator=(RValue<Float> rhs);
	RValue<Float8> operator=(const Float &rhs);
	RValue<Float8> operator=(const Reference<Float> &rhs);

	//template<int T>
	//RValue<Float8> operator=(const SwizzleMask1<Float8, T> &rhs);
	//template<int T>
	//RValue<Float8> operator=(const Swizzle4<Float8, T> &rhs);
...
inline RValue<Int8> CmpGT(RValue<Float8> x, RValue<Float8> y)
{
	return CmpNLE(x, y);
}
inline RValue<Int8> CmpGE(RValue<Float8> x, RValue<Float8> y)
{
	return CmpNLT(x, y);
}
...
inline RValue<Int8> CmpUGT(RValue<Float8> x, RValue<Float8> y)
{
	return CmpUNLE(x, y);
}
inline RValue<Int8> CmpUGE(RValue<Float8> x, RValue<Float8> y)
{
	return CmpUNLT(x, y);
}
...
//RValue<Float8> Frac(RValue<Float8> x);
RValue<Float8> Floor(RValue<Float8> x);
//RValue<Float8> Ceil(RValue<Float8> x);
//
// Trigonometric functions
// TODO: Currently unimplemented for Subzero.
